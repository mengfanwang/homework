...
\begin{document}
	...
	\begin{figure}[H]
				...
				\subfigure{
					\begin{minipage}{14cm}
					\centering 
					\includegraphics[height=8cm]{roc.jpg}
					\end{minipage}
				}
				\caption{ROC curves} 
			\end{figure}
